...
- This plugin bundles the **keeper-docs** MCP server (docs.keeper.io) - use its `searchDocumentation` / `getPage` tools to verify install steps and command syntax live instead of guessing
